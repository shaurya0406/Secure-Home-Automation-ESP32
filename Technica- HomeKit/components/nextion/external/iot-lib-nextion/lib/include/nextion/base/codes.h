...
extern "C"
{
    ...
    /**
     * @typedef nex_comm_err_t
     * @brief Communication functions return code.
     */
    typedef uint8_t nex_comm_err_t;

/**
 * Communication port success.
 */
#define NEX_COMM_OK 0x00U

/**
 * Communication port failure.
 */
#define NEX_COMM_FAIL 0x01U

/**
 * Communication port read/write timeout.
 */
#define NEX_COMM_TIMEOUT 0x02U
